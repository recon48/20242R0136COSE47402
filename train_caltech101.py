# -*- coding: utf-8 -*-
"""train_caltech101.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kB0uB-flUUL-K9NC7EBjuRid7As8QsCm
...
!zip -r /content/drive/MyDrive/cropped_101_ObjectCategories.zip /content/drive/MyDrive/cropped_101_ObjectCategories

# Commented out IPython magic to ensure Python compatibility.
# %cd ./ProMetaR/data

!cp "/content/drive/My Drive/cropped_101_ObjectCategories.zip" ./

!unzip ./cropped_101_ObjectCategories.zip -d ./caltech-101/

!mv ./caltech-101/content/drive/MyDrive/cropped_101_ObjectCategories ./caltech-101/101_ObjectCategories
!rm -r ./caltech-101/content  # 불필요한 상위 디렉토리 삭제
...
# %cd data
# %mkdir caltech-101
#!wget https://data.caltech.edu/records/mzrjq-6wc02/files/caltech-101.zip?download=1 -O caltech.zip
!cp "/content/drive/My Drive/101_ObjectCategories.tar.gz" ./  # Colab의 현재 디렉토리로 복사
import tarfile
